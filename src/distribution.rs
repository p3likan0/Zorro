...
pub async fn handle_get_published_distributions(State(shared_object): State<Arc<repository::Repository>>) -> impl IntoResponse {
...
pub async fn handle_add_package_to_distribution(
    ...
    match database::insert_package_to_distribution(&shared_object.db_conn, &dist_package.package, &dist_package.distribution){
